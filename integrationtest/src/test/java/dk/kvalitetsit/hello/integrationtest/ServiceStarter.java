...
public class ServiceStarter {
    ...
    private static final Logger serviceLogger = LoggerFactory.getLogger("sandbox-service");
    ...
    public GenericContainer startServicesInDocker() {
        ...
        var resourcesContainerName = "sandbox-service-resources";
        ...
        if (resourcesRunning) {
            ...
            service = new GenericContainer<>("local/sandbox-service-qa:dev")
        ...
        service.withNetwork(dockerNetwork)
                .withNetworkAliases("sandbox-service")
